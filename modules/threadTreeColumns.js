...
Cu.import("resource://headercolumns/log.js");
let Log = setupLogging("headercolumns.threadTreeColumns");
Cu.import("resource://headercolumns/stdlib/msgHdrUtils.js");
...
function doOnceLoaded() {
  let headerList = unicodeConverter.ConvertToUnicode(Prefs.getCharPref("headers")).split(/[ ]+/)
